	...
	<div class="page-header">
		...
		<div class="games-nav">
			<nav>
				...
				<RouterLink :to="{ path: 'games', query: { sortBy: 'popular', sortDir } }"
					:class="{ active: sortBy === 'popular' }">
					Popurlarity</RouterLink>
				<RouterLink :to="{ path: 'games', query: { sortBy: 'uploaddate', sortDir } }"
					:class="{ active: sortBy === 'uploaddate' }">Recently Updated</RouterLink>
				<RouterLink :to="{ path: 'games', query: { sortBy: 'title', sortDir } }"
					:class="{ active: sortBy === 'title' }">
					Alphabetically</RouterLink>
			</nav>
			<nav>
				<RouterLink :to="{ path: 'games', query: { sortBy, sortDir: 'asc' } }" :class="{ active: sortDir === 'asc' }">
					ASC
				</RouterLink>
				<RouterLink :to="{ path: 'games', query: { sortBy, sortDir: 'desc' } }" :class="{ active: sortDir === 'desc' }">
					DESC
				</RouterLink>
